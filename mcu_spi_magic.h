...
#define write8(d) spiXfer(d)
#define read8(dst) { dst=spiXfer(0xFF);}
#define setWriteDir() 
#define setReadDir()  
...
#else
    #define CD_COMMAND  GPIO_CD_LOW()    
    #define CD_DATA     GPIO_CD_HIGH()
    #define CS_ACTIVE   
    #define CS_IDLE     
//    #define CS_ACTIVE   GPIO_CS_LOW()
//    #define CS_IDLE     GPIO_CS_HIGH()
#endif
