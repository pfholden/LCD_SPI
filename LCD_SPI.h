...
#define DEFAULT_MODEL ILI9341
#define DEFAULT_LED PORT_PA15
#define DEFAULT_CD PORT_PA14
#define DEFAULT_RST PORT_PA11
#define DEFAULT_CS PORT_PA09
#define GPIO_GROUP 0

#define GPIO_LED_LOW()					PORT->Group[GPIO_GROUP].OUTCLR.reg = DEFAULT_LED;
#define GPIO_LED_HIGH()					PORT->Group[GPIO_GROUP].OUTSET.reg = DEFAULT_LED;
#define GPIO_RST_LOW()					PORT->Group[GPIO_GROUP].OUTCLR.reg = DEFAULT_RST;
#define GPIO_RST_HIGH()					PORT->Group[GPIO_GROUP].OUTSET.reg = DEFAULT_RST;
#define GPIO_CD_LOW()					PORT->Group[GPIO_GROUP].OUTCLR.reg = DEFAULT_CD;
#define GPIO_CD_HIGH()					PORT->Group[GPIO_GROUP].OUTSET.reg = DEFAULT_CD;
#define GPIO_CS_LOW()					PORT->Group[GPIO_GROUP].OUTCLR.reg = DEFAULT_CS;
#define GPIO_CS_HIGH()					PORT->Group[GPIO_GROUP].OUTSET.reg = DEFAULT_CS;
